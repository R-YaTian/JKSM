...
* [WinterMute](https://github.com/WinterMute)、[fincs](https://github.com/fincs) 和 [devkitPro](https://devkitpro.org/) 贡献者提供 devkitARM 和 [libctru](https://github.com/devkitPro/libctru)
