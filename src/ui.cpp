...
const std::string TITLE_TEXT = "TY Save Studio - v1.1.7 ";
...
void ui::init()
{
    ...
    ok = new ui::button(getText("确定 \ue000"), 96, 184, 128, 32);
    yes = new ui::button(getText("是 \ue000"), 32, 184, 120, 32);
    no  = new ui::button(getText("否 \ue001"), 168, 184, 120, 32);
